...
- **Concurrent Sharded Keyspace**: 64 independent mutex-striped shards eliminate global GIL/single-thread bottlenecks, delivering **>210,000 ops/sec** on local workstations.
